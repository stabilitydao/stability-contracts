...
contract PendleWrappedMetaVaultAdapterUpgradeTest is SonicSetup {
    ...
    address public constant HOLDER_WMETA_USD = 0x05e83625E774730A17094c742089e8596075368A;
    ...
    function testDecodeData() internal pure {
        bytes memory raw =
            hex"";
        ...
        (
            ...
            uint amountToSeed,
            address syOwner
        ) = abi.decode(args, (bytes, bytes, IPendleCommonPoolDeployHelperV2.PoolConfig, address, uint, address));
    ...
    function testDeploy() public {
        PendleWrappedMetaVaultAdapter pendleAdapter =
            PendleWrappedMetaVaultAdapter(SonicConstantsLib.PENDLE_STABILITY_WMETAUSD_ADAPTER); // 0x174f8D9d8A9b25D14142BB0cB9d040060a1CF75C;
