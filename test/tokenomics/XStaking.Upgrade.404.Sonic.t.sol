...
contract XStakingUpgrade404SonicTest is Test {
    ...
    function testDepositWithdrawXStaking() public {
        ...
        // ------------------------------- Upgrade and sync
        IDAO dao = _upgradeAndSetup();

        vm.prank(multisig);
        xStaking.syncDAOBalances(users);

        assertEq(dao.getVotes(USER1), 5000e18, "1: user 1 power");
        assertEq(dao.getVotes(USER2), 0, "1: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "1: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 4000e18, "2: user 1 power");
        assertEq(dao.getVotes(USER2), 4000e18, "2: user 2 power");
        assertEq(dao.getVotes(USER3), 4000e18, "2: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "3: user 1 power");
        assertEq(dao.getVotes(USER2), 5000e18, "3: user 2 power");
        assertEq(dao.getVotes(USER3), 5000e18, "3: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 8000e18, "4: user 1 power");
        assertEq(dao.getVotes(USER2), 0, "4: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "4: user 3 power");
    ...
    function testDelegation() public {
        ...
        // ------------------------------- Upgrade and sync
        IDAO dao = _upgradeAndSetup();
        assertEq(dao.minimalPower(), 4000e18, "initial minimal power is very high");
        ...
        assertEq(dao.getVotes(USER1), 0, "1: user 1 power");
        assertEq(dao.getVotes(USER2), 0, "1: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "1: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "2: user 1 power");
        assertEq(dao.getVotes(USER2), 0, "2: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "2: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "2: user 1 power");
        assertEq(dao.getVotes(USER2), balance2 + balance1 + balance3, "2: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "2: user 3 power");
        ...
        vm.prank(USER3);
        dao.setPowerDelegation(USER3);

        assertEq(dao.getVotes(USER1), balance1, "4: user 1 power");
        assertEq(dao.getVotes(USER2), balance2, "4: user 2 power");
        assertEq(dao.getVotes(USER3), balance3, "4: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "5: user 1 power");
        assertEq(dao.getVotes(USER2), balance3, "5: user 2 power");
        assertEq(dao.getVotes(USER3), balance1 + balance2, "5: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "6: user 1 power");
        assertEq(dao.getVotes(USER2), 2 * balance3, "6: user 2 power");
        assertEq(dao.getVotes(USER3), 2 * (balance1 + balance2), "6: user 3 power");
        ...
        assertEq(dao.getVotes(USER1), 0, "7: user 1 power");
        assertEq(dao.getVotes(USER2), 2 * balance3, "7: user 2 power");
        assertEq(dao.getVotes(USER3), 0, "7: user 3 power");
    ...
    function _upgradeAndSetup() internal returns (IDAO) {
        IDAO dao = _createStabilityDAOInstance();
        _upgradePlatform();

        vm.prank(multisig);
        IPlatform(PLATFORM).setupStabilityDAO(address(dao));
