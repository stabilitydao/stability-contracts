...
abstract contract Utils is Test {
    ...
    function parseURI(string memory uri) public pure returns (
        string memory name,
    ...
    function writeNftSvgToFile(address nft_, uint tokenId, string memory path) public returns (string memory name, string memory description, string memory svg) {
