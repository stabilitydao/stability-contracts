...
struct PoolConfig {
    ...
    uint staticSwapFeePercentage;
    uint aggregateSwapFeePercentage;
    uint aggregateYieldFeePercentage;
...
struct PoolData {
    ...
    TokenInfo[] tokenInfo;
    uint[] balancesRaw;
    uint[] balancesLiveScaled18;
    uint[] tokenRates;
    uint[] decimalScalingFactors;
}
...
struct AfterSwapParams {
    ...
    uint tokenInBalanceScaled18;
    uint tokenOutBalanceScaled18;
    uint amountCalculatedScaled18;
    uint amountCalculatedRaw;
    address router;
    address pool;
    bytes userData;
}
...
uint constant FEE_BITLENGTH = 24;
uint constant FEE_SCALING_FACTOR = 1e11;
...
uint constant MAX_FEE_PERCENTAGE = 99.9999e16; // 99.9999%
