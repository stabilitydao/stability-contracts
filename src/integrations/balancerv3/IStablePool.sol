...
struct StablePoolImmutableData {
    ...
    uint amplificationParameterPrecision;
}
...
interface IStablePool is IBasePool {
     ...
     */
    function startAmplificationParameterUpdate(uint rawEndValue, uint endTime) external;
    ...
    function getAmplificationState()
        external
        view
        returns (AmplificationState memory amplificationState, uint precision);
