...
interface IPoolEvents {
    ...
    event Burn(
        address indexed owner, int24 indexed tickLower, int24 indexed tickUpper, uint128 qty, uint qty0, uint qty1
    );
    ...
    event BurnRTokens(address indexed owner, uint qty, uint qty0, uint qty1);
    ...
    event Flash(address indexed sender, address indexed recipient, uint qty0, uint qty1, uint paid0, uint paid1);
}
