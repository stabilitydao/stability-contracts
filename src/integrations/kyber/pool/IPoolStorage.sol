...
interface IPoolStorage {
    ...
    function ticks(int24 tick)
        external
        view
        returns (uint128 liquidityGross, int128 liquidityNet, uint feeGrowthOutside, uint128 secondsPerLiquidityOutside);
    ...
    function getPositions(
        ...
        int24 tickLower,
        int24 tickUpper
    ) external view returns (uint128 liquidity, uint feeGrowthInsideLast);
    ...
    function getFeeGrowthGlobal() external view returns (uint);
