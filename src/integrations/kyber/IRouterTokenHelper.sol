...
interface IRouterTokenHelper {
    ...
    function unwrapWeth(uint minAmount, address recipient) external payable;
    ...
    function transferAllTokens(address token, uint minAmount, address recipient) external payable;
}
