...
interface IAlgebraPoolState {
    ...
    function ticks(int24 tick)
        ...
        returns (
            ...
            int24 prevTick,
            int24 nextTick,
            uint outerFeeGrowth0Token,
            uint outerFeeGrowth1Token
        );
    ...
    function tickTable(int16 wordPosition) external view returns (uint);

    /// @notice The fee growth as a Q128.128 fees of token0 collected per unit of liquidity for the entire life of the pool
    /// @dev This value can overflow the uint256
    /// @return The fee growth accumulator for token0
    function totalFeeGrowth0Token() external view returns (uint);

    /// @notice The fee growth as a Q128.128 fees of token1 collected per unit of liquidity for the entire life of the pool
    /// @dev This value can overflow the uint256
    /// @return The fee growth accumulator for token1
    function totalFeeGrowth1Token() external view returns (uint);
    ...
    function positions(bytes32 key)
        external
        view
        returns (uint liquidity, uint innerFeeGrowth0Token, uint innerFeeGrowth1Token, uint128 fees0, uint128 fees1);
    ...
    function tickTreeSecondLayer(int16) external view returns (uint);
}
