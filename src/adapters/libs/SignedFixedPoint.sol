...
library SignedFixedPoint {
    ...
    function addMag(int a, int b) internal pure returns (int c) {
    ...
    function mulDownMag(int a, int b) internal pure returns (int) {
        int product = a * b;
    ...
    function mulDownMagU(int a, int b) internal pure returns (int) {
        return (a * b) / ONE;
    }

    /// @dev This rounds away from 0, i.e., up *in absolute value*!
    function mulUpMag(int a, int b) internal pure returns (int) {
        int product = a * b;
        if (!(a == 0 || product / a == b)) _require(false, Errors.MUL_OVERFLOW);
    ...
    function mulUpMagU(int a, int b) internal pure returns (int) {
        int product = a * b;
    ...
    function divDownMag(int a, int b) internal pure returns (int) {
    ...
    function divDownMagU(int a, int b) internal pure returns (int) {
        if (b == 0) _require(false, Errors.ZERO_DIVISION);
        return (a * ONE) / b;
    }

    /// @dev Rounds away from 0, i.e., up in absolute value.
    function divUpMag(int a, int b) internal pure returns (int) {
        if (b == 0) _require(false, Errors.ZERO_DIVISION);
    ...
    function divUpMagU(int a, int b) internal pure returns (int) {
        if (b == 0) _require(false, Errors.ZERO_DIVISION);
    ...
    function mulXp(int a, int b) internal pure returns (int) {
        int product = a * b;
        if (!(a == 0 || product / a == b)) _require(false, Errors.MUL_OVERFLOW);
    ...
    function mulXpU(int a, int b) internal pure returns (int) {
        return (a * b) / ONE_XP;
    }
    ...
    function divXp(int a, int b) internal pure returns (int) {
        if (b == 0) _require(false, Errors.ZERO_DIVISION);
    ...
    function divXpU(int a, int b) internal pure returns (int) {
        if (b == 0) _require(false, Errors.ZERO_DIVISION);
    ...
    function mulDownXpToNp(int a, int b) internal pure returns (int) {
        int b1 = b / 1e19;
        int prod1 = a * b1;
    ...
    function mulDownXpToNpU(int a, int b) internal pure returns (int) {
        int b1 = b / 1e19;
        int b2 = b % 1e19;
    ...
    /// returns normal precision of the product
    function mulUpXpToNp(int a, int b) internal pure returns (int) {
        int b1 = b / 1e19;
        int prod1 = a * b1;
        if (!(a == 0 || prod1 / a == b1)) _require(false, Errors.MUL_OVERFLOW);
        int b2 = b % 1e19;
    ...
    function mulUpXpToNpU(int a, int b) internal pure returns (int) {
        int b1 = b / 1e19;
        int b2 = b % 1e19;
        // SOMEDAY check if we eliminate these vars and save some gas (by only checking the sign of prod1, say)
        int prod1 = a * b1;
     ...
     */
    function complement(int x) internal pure returns (int) {
