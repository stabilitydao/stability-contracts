...
/// @title EIP1967 Upgradeable proxy implementation for RecoveryToken
///         ┏┓┏┳┓┏┓┳┓┳┓ ┳┏┳┓┓┏  ┏┓┓ ┏┓┏┳┓┏┓┏┓┳┓┳┳┓
///         ┗┓ ┃ ┣┫┣┫┃┃ ┃ ┃ ┗┫  ┃┃┃ ┣┫ ┃ ┣ ┃┃┣┫┃┃┃
///         ┗┛ ┻ ┛┗┻┛┻┗┛┻ ┻ ┗┛  ┣┛┗┛┛┗ ┻ ┻ ┗┛┛┗┛ ┗
/// @author Alien Deployer (https://github.com/a17)
contract RecoveryTokenProxy is UpgradeableProxy, IMetaProxy {
    ...
    function _getImplementation() internal view returns (address) {
        return IMetaVaultFactory(msg.sender).recoveryTokenImplementation();
    }
}
